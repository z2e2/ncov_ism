This full alignment (msa_1013.fasta) is based on 141,377 submissions to EpiCoV.
Both duplicate and low-quality sequences (>5% NNNNs) have been removed, using only complete sequences (length >29,000 bp). The resulting alignment of 131,923 sequences is created using mafft https://doi.org/10.1093/molbev/mst010 in 3 separate steps.
...
mafft --thread 1 --quiet --keeplength --add sequencesNotCausingInsertionsInRef.fa seqsCausingInsertionsInRef_aligned.fasta > msa_1013.fasta
